...
'''
    VDI FTP Tool, Copyrights Kevin Nishimura
...
class app:
    ...
    def connect_to_ftp(self):        
       #Show message box
        self.float_window = Filedialogs.floating_message_dialog(self.master, "VDI FTP Tool", self.connect_icon, "Attempting to connect..." )
    ...
    def update_file_list_thread(self):
        try:
           ...
           #Set the window title to current path
            thread_request_queue.put(lambda:self.master.wm_title('VDI FTP Tool-'+self.ftpController.pwd()))
            thread_request_queue.put(lambda:self.unlock_status_bar())
        except:
            thread_request_queue.put(lambda:self.unlock_status_bar())
    ...
    def rename_file_thread(self):
       ...
       #Show message box
        self.float_window = Filedialogs.floating_message_dialog(self.master, "VDI FTP Tool", self.rename_icon, "Renaming file..." )
       #start thread
    ...
    def change_permissions_thread(self):
       ...
       #Show message box
        self.float_window = Filedialogs.floating_message_dialog(self.master, "VDI FTP Tool", self.permissions_icon, "Changing file permissions..." )
       #start thread
    ...
    def create_dir_thread(self):
       ...
       #Show message box
        self.float_window = Filedialogs.floating_message_dialog(self.master, "VDI FTP Tool", self.newfolder_icon, "Creating directory..." )
    ...
    def info(self):
        self.info_window = Filedialogs.message_dialog(self.master, 'About', self.whipFTP_icon, 'VDI FTP Tool v1.5, Fork of whipFTP, re-written by:\nKevin Nishimura\nSite:kevinnish.com\nGithub:kevinnish') 
